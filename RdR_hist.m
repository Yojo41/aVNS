function [alpha, RdR] = RdR_hist(i_Rpeaks,t_Rpeaks, t_onset, pltflag, colorflag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: 
...
if pltflag == 1 
    ...
    %%%
    scatterhist(alpha,((RR_1 ./ RR_0) -1 )* 100,'Kernel','on','Direction','out',...
        'Color','kbr', 'LineStyle',{'-','-.',':'},'Marker','+od',...
        'Parent',hp1,'Group',colorflag);
    %
    ...
    %%%
    scatterhist(alpha,((RR_2 ./ RR_0) -1 )* 100,'Kernel','on','Direction','out',...
        'Color','kbr', 'LineStyle',{'-','-.',':'},'Marker','+od',...
        'Parent',hp2,'Group',colorflag);  
    ...
    ylabel('$\Delta RR \quad [\%]$','interpreter','latex');
    %%%
    scatterhist(alpha,((RR_3 ./ RR_0) -1 )* 100,'Kernel','on','Direction','out',...
        'Color','kbr', 'LineStyle',{'-','-.',':'},'Marker','+od',...
        'Parent',hp3,'Group',colorflag); 
    ...
    ylabel('$\Delta RR \quad [\%]$','interpreter','latex');
    %%%
    scatterhist(alpha,((RR_4 ./ RR_0) -1 )* 100,'Kernel','on','Direction','out',...
        'Color','kbr', 'LineStyle',{'-','-.',':'},'Marker','+od',...
        'Parent',hp4,'Group',colorflag); 
